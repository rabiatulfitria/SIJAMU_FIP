...
Route::middleware(['cekLogin'])->group(function () {
    ...
    Route::get('/edit-dokumen-pelaksanaan/{id}', [pelaksanaan1Controller::class, 'editPelaksanaan'])->name('editPelaksanaan');;
    Route::post('/update-dokumen-pelaksanaan/{id}', [pelaksanaan1Controller::class, 'updatePelaksanaan'])->name('updatePelaksanaan');;
    Route::delete('/hapus-dokumen-pelaksanaan{id}', [pelaksanaan1Controller::class, 'deletePelaksanaan'])->name('deletePelaksanaan');;
    ...
    Route::get('/edit-dokumen-pelaksanaan-fakultas/{id}', [pelaksanaan1Controller::class, 'editPelaksanaanFakultas'])->name('editPelaksanaanFakultas');;
    Route::post('/update-dokumen-pelaksanaan-fakultas/{id}', [pelaksanaan1Controller::class, 'updatePelaksanaanFakultas'])->name('updatePelaksanaanFakultas');;
    Route::delete('/hapus-dokumen-pelaksanaan-fakultas/{id}', [pelaksanaan1Controller::class, 'deletePelaksanaanFakultas'])->name('deletePelaksanaanFakultas');;
