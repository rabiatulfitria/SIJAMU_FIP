                        ...
                        <form method="POST" action="{{ url('tambahDokumenPeningkatan-2') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="bidang_standar" name="bidang_standar" required
                                    ...
                                    <option value="Standar Pengabdian">Standar Layanan Kemahasiswaan Universitas
                                        Trunojoyo Madura</option>
                                    <option value="Standar ">Standar Layanan Kerjasama Universitas Trunojoyo Madura</option>
                                    <option value="Standar ">Standar Tata Kelola Universitas Trunojoyo Madura</option>
                                </select>
                                {{-- <div class="mb-3" id="manualNamaDokumen" style="display: none; padding-top:8px">
                                    ...
                                    <input type="text" class="form-control" id="manual_namaBidangStandar"
                                        name="manual_namaBidangStandar" placeholder="Nama Standar Lainnya" />
                                </div> --}}
                            </div>
