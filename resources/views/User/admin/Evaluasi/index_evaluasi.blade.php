            ...
            <table class="table">
                <thead class="table-purple">
                    <tr>
                        ...
                        <th style="padding-left: 30px">Program Studi</th>
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td><i class="me-3"></i>Pendidikan Bahasa dan Sasatra Indonesia</td>
                        <td><i class="me-3"></i> yyyy/mm/dd</td>
                        <td><i class="me-3"></i> yyyy/mm/dd</td>
                        <td><span class="badge bg-label-info me-1"><i class="bi bi-link-45deg">file</i></span></td>
                        <td>
                            <div class="dropdown">
